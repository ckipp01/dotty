...
import dotty.tools.dotc.util.Signatures.{Param as P, Signature as S}
...
class SignatureHelpTest:
  ...
  @Test def properFunctionReturnWithoutParenthesis: Unit =
    val listSignature =
      S("apply", List("A"), List(List(P("elems", "A*"))), Some("List[A]"))
    val optionSignature =
  ...
  @Test def methodTypeParameter: Unit =
    val applySignature = S(
      "apply",
      List("K", "V"),
      List(List(P("elems", "(K, V)*"))),
      Some("Map[K, V]")
    )
    val emptySignature = S("empty", List("K", "V"), Nil, Some("Map[K, V]"))
    code"""object O:
  ...
  @Test def typeParameterIndex: Unit =
    val mapSignature =
      S("map", List("B"), List(List(P("f", "Int => B"))), Some("List[B]"))
    code"""object O {
  ...
  @Test def partialyFailedCurriedFunctions: Unit =
    val listSignature = S(
      "curry",
      Nil,
      List(List(P("a", "Int"), P("b", "Int")), List(P("c", "Int"))),
      Some("Int")
    )
    code"""object O {
  ...
  @Test def nestedUnapplySignature: Unit =
    val signatureOneTwo =
      S("", Nil, List(List(P("a", "One"), P("b", "Two"))), None)
  ...
  @Test def properParameterIndexTest: Unit =
    val signature =
      S("", Nil, List(List(P("a", "Int"), P("b", "String"))), None)
  ...
  @Test def noUnapplySignatureWhenApplyingUnapply: Unit =
    val signature =
      S("unapply", List("A"), List(List(P("a", "A"))), Some("Some[(A, A)]"))
  ...
  @Test def sequenceMatchUnapply: Unit =
    ...
    val signatureVariadicExtractor =
      S("", Nil, List(List(P("", "Int"), P("", "List[Int]"))), None)
  ...
  @Test def productTypeClassMatch: Unit =
    val signature =
      S("", Nil, List(List(P("", "String"), P("", "String"))), None)
  ...
  @Test def nameBasedMatch: Unit =
    val nameBasedMatch =
      S("", Nil, List(List(P("", "Int"), P("", "String"))), None)
  ...
  @Test def productSequenceMatch: Unit =
    val signature =
      S("", Nil, List(List(P("", "String"), P("", "Seq[Int]"))), None)
  ...
  @Test def productSequenceMatchForCaseClass: Unit =
    val signature = S(
      "",
      Nil,
      List(List(P("name", "String"), P("children", "Seq[Int]"))),
      None
    )
  ...
  @Test def hiddenDummyParams: Unit =
    ...
    val foo3Sig =
      S(
        "foo3",
        Nil,
        List(List(P("param0", "Int")), List(P("dummy", "DummyImplicit"))),
        Some("Int")
      )
    val foo4Sig =
      S(
        ...
        List(
          List(P("param0", "Int")),
          List(
            P("x", "Int", isImplicit = true),
            P("dummy", "DummyImplicit", isImplicit = true)
          )
        ),
        Some("Int")
      )
  ...
  @Test def twoParams: Unit =
    val signature = S(
      "foo",
      Nil,
      List(List(P("param0", "Int"), P("param1", "String"))),
      Some("Int")
    )
    code"""object O {
  ...
  @Test def singleMatchingOverload: Unit =
    ...
    val sig1 = S(
      "foo",
      Nil,
      List(List(P("param0", "String"), P("param1", "Int"))),
      Some("Nothing")
    )
    code"""object O {
  ...
  @Test def multipleMatchingOverloads: Unit =
    val sig0 = S(
      "foo",
      Nil,
      List(List(P("param0", "Int"), P("param1", "Int"))),
      Some("Nothing")
    )
    val sig1 = S(
      "foo",
      Nil,
      List(List(P("param0", "Int"), P("param1", "Boolean"))),
      Some("Nothing")
    )
    val sig2 = S(
      "foo",
  ...
  end multipleMatchingOverloads

  @Test def ambiguousOverload: Unit =
    val sig0 = S(
      "foo",
      Nil,
      List(List(P("param0", "String")), List(P("param1", "String"))),
      Some("Nothing")
    )
  ...
  @Test def constructorCallDoc: Unit =
    val signatures = List(
      ...
      S(
        ...
        List(
          List(
            P("z", "Boolean", Some("A boolean")),
            P("foo", "Foo", Some("A Foo"))
          )
        ),
        None,
        Some("An alternative constructor for Foo")
      )
    )
  ...
  @Test def nestedApplySignatures: Unit =
    ...
    val booSignature =
      S(s"boo", Nil, List(List(P("x", "Int"), P("y", "Int"))), Some("Int"))
    code"""|object O:
           |  def foo1(x: Int): Int = ???
           |  def foo2(x: Int): Int = ???
           |  def foo3(x: Int): Int = ???
  ...
  @Test def multipleNestedApplySignatures: Unit =
    val simpleSignature =
      S(s"simpleFoo", Nil, List(List(P("x", "Int"))), Some("Int"))
    val complicatedSignature = S(
      s"complicatedFoo",
      Nil,
      List(List(P("x", "Int"), P("y", "Int"), P("z", "Int"))),
      Some("Int")
    )
    code"""|object O:
  ...
  end multipleNestedApplySignatures

...
class RenameTest:
  ...
  @Test def rename0: Unit =
    def testRenameFrom(m: CodeMarker) =
      code"class ${m1}Foo$m2 { new ${m3}Foo$m4 }".rename(
        m,
        "Bar",
        Set(m1 to m2, m3 to m4)
      )
    testRenameFrom(m1)
    testRenameFrom(m3)
  ...
  def renameRenamingImport: Unit =
    ...
    testRename(
      m7,
      Set(m7 to m8, m9 to m10, m11 to m12, m15 to m16, m17 to m18, m19 to m20)
    )
    testRename(
      m8,
      Set(m7 to m8, m9 to m10, m11 to m12, m15 to m16, m17 to m18, m19 to m20)
  ...
  end renameRenamingImport

  /*@Test*/
  def renameRenamingImportNested: Unit =
    def sources =
      withSources(
  ...
  end renameRenamingImportNested
  ...
  @Test def renameOverridden: Unit =
    ...
    testRename(
      m3,
      Set(m1 to m2, m3 to m4, m5 to m6),
      withOverridden = Some(true)
    )
    testRename(
      m4,
      Set(m1 to m2, m3 to m4, m5 to m6),
  ...
  /*@Test*/
  def renameValMultiProject: Unit =
    def testRename(m: CodeMarker, expectations: Set[CodeRange]) =
  ...
  /*@Test*/
  def renameClassMultiProject: Unit =

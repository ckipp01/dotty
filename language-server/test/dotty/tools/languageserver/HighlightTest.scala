...
class HighlightTest:
  ...
  @Test def valHighlight1: Unit =
    ...
    code"class X { val $xDef = 9; $xRef}"
      .highlight(
        xRef.range,
        (xDef.range, DocumentHighlightKind.Read),
        (xRef.range, DocumentHighlightKind.Read)
      )
  ...
  @Test def importHighlight2: Unit =
    code"""object ${m1}Foo${m2} { object ${m3}Bar${m4} { object ${m5}Baz${m6} } }
      ...
      .highlight(
        m3 to m4,
        (m3 to m4, DocumentHighlightKind.Read),
        (m9 to m10, DocumentHighlightKind.Read)
      )
      .highlight(
        m5 to m6,
        (m5 to m6, DocumentHighlightKind.Read),
        (m11 to m12, DocumentHighlightKind.Read)
      )
      .highlight(
        m7 to m8,
        (m1 to m2, DocumentHighlightKind.Read),
  ...
  @Test def importHighlightWithRename: Unit =
    code"""object ${m1}Foo${m2} { object ${m3}Bar${m4} { object ${m5}Baz${m6} } }
      ...
      .highlight(
        ...
        (m5 to m6, DocumentHighlightKind.Read),
        (m11 to m12, DocumentHighlightKind.Read),
        (m13 to m14, DocumentHighlightKind.Read)
      )
      .highlight(
        m7 to m8,
        (m1 to m2, DocumentHighlightKind.Read),

...
object flagtest:
  ...
  val pro =
    Protected // > pro  : dotty.tools.dotc.core.Flags.FlagSet = protected
  val pripro =
    pri | pro // > pripro  : dotty.tools.dotc.core.Flags.FlagSet = private protected
  ...
  val pp = allOf(
    pri,
    pro
  ) // > pp  : dotty.tools.dotc.core.Flags.FlagSet = private protected

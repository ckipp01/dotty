...
object SimpleIdentitySet:
  ...
  private class Set1[+Elem <: AnyRef](x0: AnyRef)
  ...
  private class Set2[+Elem <: AnyRef](x0: AnyRef, x1: AnyRef)
      extends SimpleIdentitySet[Elem]:
    def size = 2
    def +[E >: Elem <: AnyRef](x: E): SimpleIdentitySet[E] =
    ...
    def contains[E >: Elem <: AnyRef](x: E): Boolean =
      (x `eq` x0) || (x `eq` x1)
    def foreach(f: Elem => Unit): Unit =
      f(x0.asInstanceOf[Elem]); f(x1.asInstanceOf[Elem])
    def exists[E >: Elem <: AnyRef](p: E => Boolean): Boolean =
  ...
  private class Set3[+Elem <: AnyRef](x0: AnyRef, x1: AnyRef, x2: AnyRef)
      extends SimpleIdentitySet[Elem]:
    def size = 3
    def +[E >: Elem <: AnyRef](x: E): SimpleIdentitySet[E] =
    ...
    def contains[E >: Elem <: AnyRef](x: E): Boolean =
      (x `eq` x0) || (x `eq` x1) || (x `eq` x2)
    def foreach(f: Elem => Unit): Unit =
      f(x0.asInstanceOf[Elem]); f(x1.asInstanceOf[Elem]);
      f(x2.asInstanceOf[Elem])
    def exists[E >: Elem <: AnyRef](p: E => Boolean): Boolean =
      p(x0.asInstanceOf[E]) || p(x1.asInstanceOf[E]) || p(x2.asInstanceOf[E])
    def map[B <: AnyRef](f: Elem => B): SimpleIdentitySet[B] =
      Set3(
        f(x0.asInstanceOf[Elem]),
        f(x1.asInstanceOf[Elem]),
        f(x2.asInstanceOf[Elem])
      )
    def /:[A, E >: Elem <: AnyRef](z: A)(f: (A, E) => A): A =
      f(f(f(z, x0.asInstanceOf[E]), x1.asInstanceOf[E]), x2.asInstanceOf[E])
    def toList = x0.asInstanceOf[Elem] :: x1
      .asInstanceOf[Elem] :: x2.asInstanceOf[Elem] :: Nil
  ...
  private class SetN[+Elem <: AnyRef](val xs: Array[AnyRef])
      extends SimpleIdentitySet[Elem]:
    def size = xs.length
    def +[E >: Elem <: AnyRef](x: E): SimpleIdentitySet[E] =
      if contains(x) then this
      ...
      that match
        case that: SetN[?] =>
          ...
          while i < thisSize do
            val elem = this.xs(i)
            var j =
              searchStart // search thatElems in round robin fashion, starting one after latest hit
            var missing = false

...
object FreshNameCreator:
  class Default extends FreshNameCreator:
    ...
    protected val counters: mutable.Map[String, Int] =
      mutable.AnyRefMap() withDefaultValue 0

    /** Create a fresh name with the given prefix. It is guaranteed that the
      * returned name has never been returned by a previous call to this
      * function (provided the prefix does not end in a digit).
      */
    def newName(prefix: TermName, unique: UniqueNameKind): TermName =

...
object NameTags extends TastyFormat.NameTags:
  ...
  inline val TRAITSETTER =
    6 // A Scala-2 trait setter, generated by AugmentScala2Traits

  inline val OUTERSELECT =
    13 // A name `<num>_outer`, used by the inliner to indicate an
  // outer accessor that will be filled in by ExplicitOuter.
  // <num> indicates the number of hops needed to select the outer field.

  inline val PROTECTEDACCESSOR =
    24 // The name of a protected accesor `protected$<name>` created by ProtectedAccessors.

  inline val INITIALIZER = 26 // A mixin initializer method

  inline val FIELD =
    29 // Used by Memoize to tag the name of a class member field.

  inline val EXTMETH =
    30 // Used by ExtensionMethods for the name of an extension method
  // implementing a value class method.

  inline val ADAPTEDCLOSURE =
    31 // Used in Erasure to adapt closures over primitive types.
  ...
  inline val EXPLICITFIELD =
    38 // An explicitly named field, introduce to avoid a clash

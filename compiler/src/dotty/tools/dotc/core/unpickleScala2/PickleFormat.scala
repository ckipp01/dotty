...
object PickleFormat:
  ...
  /** ************************************************* Symbol table attribute
    ...
    * \| 8 VALsym len_Nat [defaultGetter_Ref /* no longer needed*/] SymbolInfo
    * [alias_Ref]
    ...
    * \| 42 ANNOTATEDtpe len_Nat [sym_Ref /* no longer needed */] tpe_Ref
    * {annotinfo_Ref}
    ...
    * \| 49 TREE len_Nat 2 PACKAGEtree type_Ref sym_Ref mods_Ref name_Ref
    * {tree_Ref}
    * \| 49 TREE len_Nat 3 CLASStree type_Ref sym_Ref mods_Ref name_Ref tree_Ref
    * {tree_Ref}
    * \| 49 TREE len_Nat 4 MODULEtree type_Ref sym_Ref mods_Ref name_Ref
    * tree_Ref
    * \| 49 TREE len_Nat 5 VALDEFtree type_Ref sym_Ref mods_Ref name_Ref
    * tree_Ref tree_Ref
    * \| 49 TREE len_Nat 6 DEFDEFtree type_Ref sym_Ref mods_Ref name_Ref
    * numtparams_Nat {tree_Ref} numparamss_Nat {numparams_Nat {tree_Ref}}
    * tree_Ref tree_Ref
    * \| 49 TREE len_Nat 7 TYPEDEFtree type_Ref sym_Ref mods_Ref name_Ref
    * tree_Ref {tree_Ref}
    * \| 49 TREE len_Nat 8 LABELtree type_Ref sym_Ref tree_Ref {tree_Ref}
    * \| 49 TREE len_Nat 9 IMPORTtree type_Ref sym_Ref tree_Ref {name_Ref
    * name_Ref}
    * \| 49 TREE len_Nat 11 DOCDEFtree type_Ref sym_Ref string_Ref tree_Ref
    * \| 49 TREE len_Nat 12 TEMPLATEtree type_Ref sym_Ref numparents_Nat
    ...
    * \| 49 TREE len_Nat 32 APPLYDYNAMICtree type_Ref sym_Ref tree_Ref
    * {tree_Ref}
    ...
    * \| 50 MODIFIERS len_Nat flags_Long privateWithin_Ref SymbolInfo = name_Ref
    * owner_Ref flags_LongNat [privateWithin_Ref] info_Ref NameInfo = <character
    * sequence of length len_Nat in Utf8 format> NumInfo = <len_Nat-byte signed
    * number in big endian format> Ref = Nat AnnotInfoBody = info_Ref
    * {annotArg_Ref} {name_Ref constAnnotArg_Ref} AnnotArg = Tree | Constant

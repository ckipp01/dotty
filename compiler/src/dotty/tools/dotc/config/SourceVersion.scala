...
enum SourceVersion:
  case `3.0-migration`, `3.0`,
    `3.1` // Note: do not add `3.1-migration` here, 3.1 is the same language as 3.0.
...
object SourceVersion extends Property.Key[SourceVersion]:
  ...
  /** language versions that may appear in a language import, are deprecated,
    * but not removed from the standard library.
    */
  ...
  /** All source versions that can be recognised from a language import. e.g.
    * `import language.3.1`
    */
  val allSourceVersionNames =
    validSourceVersionNames ::: illegalSourceVersionNames
end SourceVersion

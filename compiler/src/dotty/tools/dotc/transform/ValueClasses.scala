...
object ValueClasses:
  ...
  /** For a value class `d`, this returns the synthetic cast from the underlying
    * type to ErasedValueType defined in the companion module. This method is
    * added to the module and further described in [[ExtensionMethods]].
    */
  def u2evt(cls: ClassSymbol)(using Context): Symbol =
    cls.linkedClass.info.decl(nme.U2EVT).symbol

  /** For a value class `d`, this returns the synthetic cast from
    * ErasedValueType to the underlying type defined in the companion module.
    * This method is added to the module and further described in
    * [[ExtensionMethods]].
    */

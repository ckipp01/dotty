...
final case class Documentation(
    ...
    format: dotty.tools.dotc.semanticdb.Documentation.Format =
      dotty.tools.dotc.semanticdb.Documentation.Format.HTML
  ...
  def withMessage(__v: _root_.scala.Predef.String): Documentation =
    copy(message = __v)
  def withFormat(
      __v: dotty.tools.dotc.semanticdb.Documentation.Format
  ): Documentation = copy(format = __v)
...
object Documentation
  ...
  def parseFrom(
    ...
    var __format: dotty.tools.dotc.semanticdb.Documentation.Format =
      dotty.tools.dotc.semanticdb.Documentation.Format.HTML
    var _done__ = false
    while !_done__ do
      ...
      _tag__ match
        ...
        case 16 =>
          __format = dotty.tools.dotc.semanticdb.Documentation.Format
  ...
  sealed abstract class Format(val value: _root_.scala.Int)
    ...
    final def asRecognized: _root_.scala.Option[
      dotty.tools.dotc.semanticdb.Documentation.Format.Recognized
  ...
  object Format:
    ...
    final case class Unrecognized(unrecognizedValue: _root_.scala.Int)
        extends Format(unrecognizedValue)
        with SemanticdbUnrecognizedEnum
    lazy val values =
      scala.collection.immutable.Seq(HTML, MARKDOWN, JAVADOC, SCALADOC, KDOC)
  ...
  def of(
      message: _root_.scala.Predef.String,
      format: dotty.tools.dotc.semanticdb.Documentation.Format
  ): _root_.dotty.tools.dotc.semanticdb.Documentation =
    _root_.dotty.tools.dotc.semanticdb.Documentation(
      message,
      format
    )

...
final case class TextDocument(
    schema: dotty.tools.dotc.semanticdb.Schema =
      dotty.tools.dotc.semanticdb.Schema.LEGACY,
  ...
  def writeTo(`_output__`: SemanticdbOutputStream): _root_.scala.Unit =
    {
      ...
      if __v != 0 then _output__.writeEnum(1, __v)
    };
    {
      val __v = uri
    ...
    };
    {
      ...
      if __v != 0 then _output__.writeEnum(10, __v)
    };
    {
      val __v = md5
      if !__v.isEmpty then _output__.writeString(11, __v)
    };
  ...
  def withSchema(__v: dotty.tools.dotc.semanticdb.Schema): TextDocument =
    copy(schema = __v)
  ...
  def withLanguage(__v: dotty.tools.dotc.semanticdb.Language): TextDocument =
    copy(language = __v)
  def clearSymbols = copy(symbols = _root_.scala.Seq.empty)
  def addSymbols(
      __vs: dotty.tools.dotc.semanticdb.SymbolInformation*
  ): TextDocument = addAllSymbols(__vs)
  def addAllSymbols(
      __vs: Iterable[dotty.tools.dotc.semanticdb.SymbolInformation]
  ): TextDocument = copy(symbols = symbols ++ __vs)
  def withSymbols(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.SymbolInformation]
  ): TextDocument = copy(symbols = __v)
  def clearOccurrences = copy(occurrences = _root_.scala.Seq.empty)
  def addOccurrences(
      __vs: dotty.tools.dotc.semanticdb.SymbolOccurrence*
  ): TextDocument = addAllOccurrences(__vs)
  def addAllOccurrences(
      __vs: Iterable[dotty.tools.dotc.semanticdb.SymbolOccurrence]
  ): TextDocument = copy(occurrences = occurrences ++ __vs)
  def withOccurrences(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.SymbolOccurrence]
  ): TextDocument = copy(occurrences = __v)
  def clearDiagnostics = copy(diagnostics = _root_.scala.Seq.empty)
  def addDiagnostics(
      __vs: dotty.tools.dotc.semanticdb.Diagnostic*
  ): TextDocument = addAllDiagnostics(__vs)
  def addAllDiagnostics(
      __vs: Iterable[dotty.tools.dotc.semanticdb.Diagnostic]
  ): TextDocument = copy(diagnostics = diagnostics ++ __vs)
  def withDiagnostics(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.Diagnostic]
  ): TextDocument = copy(diagnostics = __v)
  def clearSynthetics = copy(synthetics = _root_.scala.Seq.empty)
  def addSynthetics(
      __vs: dotty.tools.dotc.semanticdb.Synthetic*
  ): TextDocument = addAllSynthetics(__vs)
  def addAllSynthetics(
      __vs: Iterable[dotty.tools.dotc.semanticdb.Synthetic]
  ): TextDocument = copy(synthetics = synthetics ++ __vs)
  def withSynthetics(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.Synthetic]
  ): TextDocument = copy(synthetics = __v)
...
object TextDocument
  ...
  def parseFrom(
    ...
    var __schema: dotty.tools.dotc.semanticdb.Schema =
      dotty.tools.dotc.semanticdb.Schema.LEGACY
    ...
    var __language: dotty.tools.dotc.semanticdb.Language =
      dotty.tools.dotc.semanticdb.Language.UNKNOWN_LANGUAGE
    val __symbols: _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.SymbolInformation
    ] = new _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.SymbolInformation
    ]
    val __occurrences: _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.SymbolOccurrence
    ] = new _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.SymbolOccurrence
    ]
    val __diagnostics: _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.Diagnostic
    ] = new _root_.scala.collection.immutable.VectorBuilder[
      dotty.tools.dotc.semanticdb.Diagnostic
    ]
    val __synthetics: _root_.scala.collection.immutable.VectorBuilder[
    ...
    while !_done__ do
      ...
      _tag__ match
        ...
        case 8 =>
          __schema =
            dotty.tools.dotc.semanticdb.Schema.fromValue(_input__.readEnum())
        case 18 =>
        ...
        case 42 =>
          __symbols += LiteParser
            .readMessage[dotty.tools.dotc.semanticdb.SymbolInformation](
              _input__
            )
        case 50 =>
          __occurrences += LiteParser
            .readMessage[dotty.tools.dotc.semanticdb.SymbolOccurrence](_input__)
        case 58 =>
          __diagnostics += LiteParser
            .readMessage[dotty.tools.dotc.semanticdb.Diagnostic](_input__)
        case 98 =>
          __synthetics += LiteParser
            .readMessage[dotty.tools.dotc.semanticdb.Synthetic](_input__)
  ...
  def of(
      ...
      diagnostics: _root_.scala.Seq[dotty.tools.dotc.semanticdb.Diagnostic],
      synthetics: _root_.scala.Seq[dotty.tools.dotc.semanticdb.Synthetic]
  ): _root_.dotty.tools.dotc.semanticdb.TextDocument =
    _root_.dotty.tools.dotc.semanticdb.TextDocument(
      schema,
      uri,
      text,

...
final case class Scope(
  ...
  def addSymlinks(__vs: _root_.scala.Predef.String*): Scope = addAllSymlinks(
    __vs
  )
  def addAllSymlinks(__vs: Iterable[_root_.scala.Predef.String]): Scope =
    copy(symlinks = symlinks ++ __vs)
  def withSymlinks(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Scope =
    copy(symlinks = __v)
  def clearHardlinks = copy(hardlinks = _root_.scala.Seq.empty)
  def addHardlinks(
      __vs: dotty.tools.dotc.semanticdb.SymbolInformation*
  ): Scope = addAllHardlinks(__vs)
  def addAllHardlinks(
      __vs: Iterable[dotty.tools.dotc.semanticdb.SymbolInformation]
  ): Scope = copy(hardlinks = hardlinks ++ __vs)
  def withHardlinks(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.SymbolInformation]
  ): Scope = copy(hardlinks = __v)
...
object Scope
  ...
  implicit def messageCompanion
      : SemanticdbGeneratedMessageCompanion[dotty.tools.dotc.semanticdb.Scope] =
    this
  def parseFrom(
      `_input__`: SemanticdbInputStream
  ): dotty.tools.dotc.semanticdb.Scope =
    val __symlinks: _root_.scala.collection.immutable.VectorBuilder[
      _root_.scala.Predef.String
    ] = new _root_.scala.collection.immutable.VectorBuilder[
      _root_.scala.Predef.String
    ]
    val __hardlinks: _root_.scala.collection.immutable.VectorBuilder[
  ...
  def of(
      symlinks: _root_.scala.Seq[_root_.scala.Predef.String],
      hardlinks: _root_.scala.Seq[dotty.tools.dotc.semanticdb.SymbolInformation]
  ): _root_.dotty.tools.dotc.semanticdb.Scope =
    _root_.dotty.tools.dotc.semanticdb.Scope(
      symlinks,
      hardlinks
    )

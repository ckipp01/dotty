...
final case class Range(
  ...
  def writeTo(`_output__`: SemanticdbOutputStream): _root_.scala.Unit =
    ...
    {
      val __v = endLine
      if __v != 0 then _output__.writeInt32(3, __v)
    };
    {
  ...
  def withStartCharacter(__v: _root_.scala.Int): Range =
    copy(startCharacter = __v)
...
object Range
  ...
  implicit def messageCompanion
      : SemanticdbGeneratedMessageCompanion[dotty.tools.dotc.semanticdb.Range] =
    this
  def parseFrom(
  ...
  ): _root_.dotty.tools.dotc.semanticdb.Range =
    _root_.dotty.tools.dotc.semanticdb.Range(
      startLine,
      startCharacter,
      endLine,

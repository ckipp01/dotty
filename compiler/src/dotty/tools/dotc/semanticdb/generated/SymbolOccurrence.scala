...
final case class SymbolOccurrence(
    ...
    role: dotty.tools.dotc.semanticdb.SymbolOccurrence.Role =
      dotty.tools.dotc.semanticdb.SymbolOccurrence.Role.UNKNOWN_ROLE
  ...
  def withRange(__v: dotty.tools.dotc.semanticdb.Range): SymbolOccurrence =
    copy(range = Option(__v))
  def withSymbol(__v: _root_.scala.Predef.String): SymbolOccurrence =
    copy(symbol = __v)
  def withRole(
      __v: dotty.tools.dotc.semanticdb.SymbolOccurrence.Role
  ): SymbolOccurrence = copy(role = __v)

  // @@protoc_insertion_point(GeneratedMessage[dotty.tools.dotc.semanticdb.SymbolOccurrence])
end SymbolOccurrence
...
object SymbolOccurrence
  ...
  def parseFrom(
    ...
    var __role: dotty.tools.dotc.semanticdb.SymbolOccurrence.Role =
      dotty.tools.dotc.semanticdb.SymbolOccurrence.Role.UNKNOWN_ROLE
    var _done__ = false
    while !_done__ do
      ...
      _tag__ match
        ...
        case 24 =>
          __role = dotty.tools.dotc.semanticdb.SymbolOccurrence.Role
  ...
  sealed abstract class Role(val value: _root_.scala.Int)
    ...
    final def asRecognized: _root_.scala.Option[
      dotty.tools.dotc.semanticdb.SymbolOccurrence.Role.Recognized
  ...
  object Role:
    ...
    final case class Unrecognized(unrecognizedValue: _root_.scala.Int)
        extends Role(unrecognizedValue)
        with SemanticdbUnrecognizedEnum
    lazy val values =
      scala.collection.immutable.Seq(UNKNOWN_ROLE, REFERENCE, DEFINITION)
  ...
  def of(
      ...
      symbol: _root_.scala.Predef.String,
      role: dotty.tools.dotc.semanticdb.SymbolOccurrence.Role
  ): _root_.dotty.tools.dotc.semanticdb.SymbolOccurrence =
    _root_.dotty.tools.dotc.semanticdb.SymbolOccurrence(
      range,
      symbol,
      role

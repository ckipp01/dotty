...
final case class Synthetic(
    ...
    tree: dotty.tools.dotc.semanticdb.Tree =
      dotty.tools.dotc.semanticdb.Synthetic._typemapper_tree
  ...
  private[this] def __computeSerializedSize(): _root_.scala.Int =
    ...
    {
      val __value =
        dotty.tools.dotc.semanticdb.Synthetic._typemapper_tree.toBase(tree)
  ...
  def withRange(__v: dotty.tools.dotc.semanticdb.Range): Synthetic =
    copy(range = Option(__v))
  def withTree(__v: dotty.tools.dotc.semanticdb.Tree): Synthetic =
    copy(tree = __v)
...
object Synthetic
  ...
  def parseFrom(
    ...
    var __range: _root_.scala.Option[dotty.tools.dotc.semanticdb.Range] =
      _root_.scala.None
    var __tree: _root_.scala.Option[dotty.tools.dotc.semanticdb.TreeMessage] =
      _root_.scala.None
    var _done__ = false
    while !_done__ do
    ...
    dotty.tools.dotc.semanticdb.Synthetic(
      range = __range,
      tree = dotty.tools.dotc.semanticdb.Synthetic._typemapper_tree.toCustom(
        __tree.getOrElse(
  ...
  lazy val defaultInstance = dotty.tools.dotc.semanticdb.Synthetic(
    ...
    tree = dotty.tools.dotc.semanticdb.Synthetic._typemapper_tree
      .toCustom(dotty.tools.dotc.semanticdb.TreeMessage.defaultInstance)
  )
  final val RANGE_FIELD_NUMBER = 1
  final val TREE_FIELD_NUMBER = 2
  @transient @sharable
  private[semanticdb] val _typemapper_tree: SemanticdbTypeMapper[
  ...
  def of(
      range: _root_.scala.Option[dotty.tools.dotc.semanticdb.Range],
      tree: dotty.tools.dotc.semanticdb.Tree
  ): _root_.dotty.tools.dotc.semanticdb.Synthetic =
    _root_.dotty.tools.dotc.semanticdb.Synthetic(
      range,
      tree
    )

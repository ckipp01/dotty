...
final case class TextDocuments(
  ...
  def addDocuments(
      __vs: dotty.tools.dotc.semanticdb.TextDocument*
  ): TextDocuments = addAllDocuments(__vs)
  def addAllDocuments(
      __vs: Iterable[dotty.tools.dotc.semanticdb.TextDocument]
  ): TextDocuments = copy(documents = documents ++ __vs)
  def withDocuments(
      __v: _root_.scala.Seq[dotty.tools.dotc.semanticdb.TextDocument]
  ): TextDocuments = copy(documents = __v)
...
object TextDocuments
  ...
  def parseFrom(
    ...
    val __documents: _root_.scala.collection.immutable.VectorBuilder[
    ...
    while !_done__ do
      ...
      _tag__ match
        case 0 => _done__ = true
        case 10 =>
          __documents += LiteParser
            .readMessage[dotty.tools.dotc.semanticdb.TextDocument](_input__)
  ...
  def of(
      documents: _root_.scala.Seq[dotty.tools.dotc.semanticdb.TextDocument]
  ): _root_.dotty.tools.dotc.semanticdb.TextDocuments =
    _root_.dotty.tools.dotc.semanticdb.TextDocuments(
      documents
    )

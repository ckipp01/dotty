...
package object parsing:
  ...
  /** Compute the precedence of infix operator `operator` according to the SLS
    * [§ 6.12.3][SLS]. We implement [SIP-33][SIP-33] and give type operators the
    * same precedence as term operators.
    *
    * [SLS]:

...
/** A TreeMap that maintains the necessary infrastructure to support contextual
  * implicit searches (type-scope implicits are supported anyway).
  *

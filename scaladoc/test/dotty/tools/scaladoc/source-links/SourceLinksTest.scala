...
class SourceLinkTest:
  ...
  def testBasicFailures() =
    def testFailure(template: String, messagePart: String) =
      ...
      assertTrue(
        s"Expected failure containing $messagePart: $res",
        res.left.exists(_.contains(messagePart))
      )
  ...
  def testProperTemplates() =
    def test(template: String) =
      val res =
        try SourceLinkParser(Some("develop")).parse(template)
        catch
          case e: Exception =>
            throw RuntimeException(s"When testing $template", e)
  ...
  def testSourceProviderWithoutRevision() =
    Seq("github", "gitlab").foreach { provider =>
      ...
      val res = SourceLinkParser(None).parse(template)
      assertTrue(
        s"Expected failure containing missing revision: $res",
        res.left.exists(_.contains("revision"))
      )
    }
end SourceLinkTest
...
class SourceLinksTest:
  ...
  type Args = String | (String, Operation) | (String, Int) |
    (String, Int, Operation)

  private def testLink(config: Seq[String], revision: Option[String])(
      cases: (Args, String | None.type)*
  ): Unit =
    ...
    cases.foreach { case (args, expected) =>
      val res = args match
        ...
        case (path: String, line: Int) =>
          links.pathTo(projectRoot.resolve(path), line = Some(line))
        case (path: String, operation: Operation) =>
          links.pathTo(projectRoot.resolve(path), operation = operation)
        case (path: String, line: Int, operation: Operation) =>
          links.pathTo(
  ...
  def testBasicPaths =
    testLink(Seq("github://lampepfl/dotty"), Some("develop"))(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/lampepfl/dotty/blob/develop/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/develop/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/develop/project/Build.scala#L54"
    )
    ...
    testLink(Seq("github://lampepfl/dotty/dev"), Some("develop"))(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/lampepfl/dotty/blob/dev/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/dev/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/dev/project/Build.scala#L54"
    )
    ...
    testLink(Seq("github://lampepfl/dotty/dev#src/lib"), None)(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/lampepfl/dotty/blob/dev/src/lib/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/dev/src/lib/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/dev/src/lib/project/Build.scala#L54"
    )
    ...
    testLink(Seq("github://lampepfl/dotty#src/lib"), Some("develop"))(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/lampepfl/dotty/blob/develop/src/lib/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/develop/src/lib/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/develop/src/lib/project/Build.scala#L54"
    )
    ...
    testLink(Seq("gitlab://lampepfl/dotty"), Some("develop"))(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://gitlab.com/lampepfl/dotty/-/blob/develop/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://gitlab.com/lampepfl/dotty/-/edit/develop/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://gitlab.com/lampepfl/dotty/-/edit/develop/project/Build.scala#L54"
    )
    ...
    testLink(
      Seq(
        "https://github.com/scala/scala/blob/2.13.x€{FILE_PATH_EXT}#L€{FILE_LINE}"
      ),
      Some("develop")
    )(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/scala/scala/blob/2.13.x/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/scala/scala/blob/2.13.x/project/Build.scala#L",
      (
        "project/Build.scala",
        54,
        edit
    ...
    testLink(
      Seq(
        "https://github.com/scala/scala/blob/2.13.x€{FILE_PATH}.scala#L€{FILE_LINE}"
      ),
      Some("develop")
    )(
      "project/Build.scala" -> "https://github.com/scala/scala/blob/2.13.x/project/Build.scala#L",
    ...
    testLink(Seq("github://lampepfl/dotty/branch/withslash#src/lib"), None)(
      ...
      (
        "project/Build.scala",
        54
      ) -> "https://github.com/lampepfl/dotty/blob/branch/withslash/src/lib/project/Build.scala#L54",
      (
        "project/Build.scala",
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/branch/withslash/src/lib/project/Build.scala",
      (
        "project/Build.scala",
        54,
        edit
      ) -> "https://github.com/lampepfl/dotty/edit/branch/withslash/src/lib/project/Build.scala#L54"
    )
  end testBasicPaths
  ...
  def testBasicPrefixedPaths =
    testLink(Seq("src=gitlab://lampepfl/dotty"), Some("develop"))(
      ...
      (
        ...
        33,
        edit
      ) -> "https://gitlab.com/lampepfl/dotty/-/edit/develop/lib/core.scala#L33",
      (
        "src/lib/core.scala",
        33,
        edit
  ...
  def prefixedPaths =
    testLink(
      ...
      (
        ...
        33,
        edit
      ) -> "https://gitlab.com/lampepfl/dotty/-/edit/develop/generated.scala#L33",

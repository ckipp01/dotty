/** Copied from
  * https://github.com/sbt/sbt/blob/0.13/interface/src/test/scala/xsbti/TestCallback.scala
  */
package xsbti
...
class TestCallback extends AnalysisCallback:
  ...
  val binaryDependencies =
    new ArrayBuffer[(File, String, String, File, DependencyContext)]
  ...
  val classNames = scala.collection.mutable.Map
    ...
    .withDefaultValue(Set.empty)
  val apis: scala.collection.mutable.Map[File, Seq[ClassLike]] =

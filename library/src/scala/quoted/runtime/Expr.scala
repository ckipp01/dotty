...
object Expr:
  ...
  /** A term splice nested within a quote is desugared by the compiler into a
    * call to this method. `ctx` is the `Quotes` that the quote of this splice
    * uses.
    *
    * Calling this method in source has undefined behavior at compile-time
    */
  @compileTimeOnly(
    "Illegal reference to `scala.quoted.runtime.Expr.nestedSplice`"
  )

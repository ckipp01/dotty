...
object ToExpr:
  ...
  given ClassToExpr[T <: Class[?]]: ToExpr[T] with
    def apply(x: T)(using Quotes) =
      ...
      Ref(defn.Predef_classOf)
        .appliedToType(TypeRepr.typeConstructorOf(x))
        .asExpr
        .asInstanceOf[Expr[T]]
  ...
  given ArrayOfBooleanToExpr: ToExpr[Array[Boolean]] with
    def apply(array: Array[Boolean])(using Quotes): Expr[Array[Boolean]] =
      if array.length == 0 then '{ Array.emptyBooleanArray }
  ...
  given ArrayOfByteToExpr: ToExpr[Array[Byte]] with
    def apply(array: Array[Byte])(using Quotes): Expr[Array[Byte]] =
      if array.length == 0 then '{ Array.emptyByteArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfShortToExpr: ToExpr[Array[Short]] with
    def apply(array: Array[Short])(using Quotes): Expr[Array[Short]] =
      if array.length == 0 then '{ Array.emptyShortArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfCharToExpr: ToExpr[Array[Char]] with
    def apply(array: Array[Char])(using Quotes): Expr[Array[Char]] =
      if array.length == 0 then '{ Array.emptyCharArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfIntToExpr: ToExpr[Array[Int]] with
    def apply(array: Array[Int])(using Quotes): Expr[Array[Int]] =
      if array.length == 0 then '{ Array.emptyIntArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfLongToExpr: ToExpr[Array[Long]] with
    def apply(array: Array[Long])(using Quotes): Expr[Array[Long]] =
      if array.length == 0 then '{ Array.emptyLongArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfFloatToExpr: ToExpr[Array[Float]] with
    def apply(array: Array[Float])(using Quotes): Expr[Array[Float]] =
      if array.length == 0 then '{ Array.emptyFloatArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }
  ...
  given ArrayOfDoubleToExpr: ToExpr[Array[Double]] with
    def apply(array: Array[Double])(using Quotes): Expr[Array[Double]] =
      if array.length == 0 then '{ Array.emptyDoubleArray }
      else '{ Array(${ Expr(array(0)) }, ${ Expr(array.toSeq.tail) }*) }

  /** Default implementation of `ToExpr[IArray[T]]` */
  given IArrayToExpr[T: Type](using
      ltArray: ToExpr[Array[T]]
  ): ToExpr[IArray[T]] with
    def apply(iarray: IArray[T])(using Quotes): Expr[IArray[T]] =
      '{
        ${ ltArray.apply(iarray.asInstanceOf[Array[T]]) }
          .asInstanceOf[IArray[T]]
      }
  ...
  given Tuple2ToExpr[T1: Type: ToExpr, T2: Type: ToExpr]: ToExpr[Tuple2[T1, T2]]
  with
    def apply(tup: Tuple2[T1, T2])(using Quotes) =
      '{ (${ Expr(tup._1) }, ${ Expr(tup._2) }) }

  /** Default implementation of `ToExpr[Tuple3[T1, T2, T3]]` */
  given Tuple3ToExpr[T1: Type: ToExpr, T2: Type: ToExpr, T3: Type: ToExpr]
      : ToExpr[Tuple3[T1, T2, T3]] with
  ...
  given Tuple4ToExpr[
      ...
      T3: Type: ToExpr,
      T4: Type: ToExpr
  ]: ToExpr[Tuple4[T1, T2, T3, T4]] with
  ...
  given Tuple5ToExpr[
      ...
      T4: Type: ToExpr,
      T5: Type: ToExpr
  ]: ToExpr[Tuple5[T1, T2, T3, T4, T5]] with
  ...
  given Tuple6ToExpr[
      ...
      T5: Type: ToExpr,
      T6: Type: ToExpr
  ]: ToExpr[Tuple6[T1, T2, T3, T4, T5, T6]] with
  ...
  given Tuple7ToExpr[
      ...
      T6: Type: ToExpr,
      T7: Type: ToExpr
  ]: ToExpr[Tuple7[T1, T2, T3, T4, T5, T6, T7]] with
  ...
  given Tuple8ToExpr[
      ...
      T7: Type: ToExpr,
      T8: Type: ToExpr
  ]: ToExpr[Tuple8[T1, T2, T3, T4, T5, T6, T7, T8]] with
  ...
  /** Default implementation of `ToExpr[Tuple9[T1, T2, T3, T4, T5, T6, T7, T8,
    * T9]]`
    */
  given Tuple9ToExpr[
      T1: Type: ToExpr,
      ...
      T8: Type: ToExpr,
      T9: Type: ToExpr
  ]: ToExpr[Tuple9[T1, T2, T3, T4, T5, T6, T7, T8, T9]] with
  ...
  /** Default implementation of `ToExpr[Tuple10[T1, T2, T3, T4, T5, T6, T7, T8,
    * T9, T10]]`
    */
  given Tuple10ToExpr[
      T1: Type: ToExpr,
      ...
      T9: Type: ToExpr,
      T10: Type: ToExpr
  ]: ToExpr[Tuple10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10]] with
    def apply(tup: Tuple10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10])(using
        Quotes
    ) =
  ...
  /** Default implementation of `ToExpr[Tuple11[T1, T2, T3, T4, T5, T6, T7, T8,
    * T9, T10, T11]]`
    */
  given Tuple11ToExpr[
      T1: Type: ToExpr,
      ...
      T10: Type: ToExpr,
      T11: Type: ToExpr
  ]: ToExpr[Tuple11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11]] with
    def apply(tup: Tuple11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11])(using
        Quotes
    ) =
  ...
  /** Default implementation of `ToExpr[Tuple12[T1, T2, T3, T4, T5, T6, T7, T8,
    * T9, T10, T11, T12]]`
    */
  given Tuple12ToExpr[
      T1: Type: ToExpr,
      ...
      T11: Type: ToExpr,
      T12: Type: ToExpr
  ]: ToExpr[Tuple12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12]] with
    def apply(tup: Tuple12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12])(
        using Quotes
    ) =
  ...
  /** Default implementation of `ToExpr[Tuple13[T1, T2, T3, T4, T5, T6, T7, T8,
    * T9, T10, T11, T12, T13]]`
    */
  given Tuple13ToExpr[
      T1: Type: ToExpr,
  ...
  with
    def apply(
        tup: Tuple13[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13]
    )(using Quotes) =
  ...
  /** Default implementation of `ToExpr[Tuple14[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple15[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  given Tuple15ToExpr[
    ...
    def apply(
      ...
      val (x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15) =
        tup
      '{
        (
          ${ Expr(x1) },
  ...
  /** Default implementation of `ToExpr[Tuple16[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple17[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple18[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple19[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple20[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple21[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  /** Default implementation of `ToExpr[Tuple22[T1, T2, T3, T4, T5, T6, T7, T8,
  ...
  given TupleConsToExpr[H: Type: ToExpr, T <: Tuple: Type: ToExpr]
      : ToExpr[H *: T] with
  ...
  /** Default implementation of `ToExpr[BigDecimal using the default
    * MathContext]`
    */

...
/** Quotation context provided by a macro expansion or in the scope of
  * `scala.quoted.staging.run`. Used to perform all operations on quoted `Expr`
  * or `Type`.
  *
  * It contains the low-level Typed AST API metaprogramming API. This API does
  * not have the static type guarantees that `Expr` and `Type` provide. `Quotes`
  * are generated from an enclosing `${ ... }` or `scala.staging.run`. For
  * example:
  * ```scala sc:nocompile
...
""")
trait Quotes:
  self: runtime.QuoteUnpickler & runtime.QuoteMatching =>
  ...
  extension [T](self: Expr[T])
    ...
    /** Pattern matches `this` against `that`. Effectively performing a deep
      * equality check. It does the equivalent of
      * ```scala sc:nocompile
      * this match
    ...
    /** Return the value of this expression.
      *
      * Returns `None` if the expression does not represent a value or possibly
      * contains side effects. Otherwise returns the `Some` of the value.
      */
    ...
    /** Return the value of this expression.
      *
      * Emits an error and throws if the expression does not represent a value
      * or possibly contains side effects. Otherwise returns the value.
      */
    ...
    /** Return the value of this expression.
      *
      * Emits an error and aborts if the expression does not represent a value
      * or possibly contains side effects. Otherwise returns the value.
      */
  ...
  extension (self: Expr[Any])
    ...
    /** Convert this to an `quoted.Expr[X]` if this expression is a valid
      * expression of type `X` or throws
      */
  ...
  /** Low-level Typed AST metaprogramming API.
    ...
    * Methods on `XYZ` are provided by a `given XYZMethods` which implements
    * extension methods on `XYZ` in the trait `XYZMethods`. The `XYZ` module is
    * defined by a `val XYZ: XYZModule` which contains the methods defined in
    * `XYZModule`. Type tests (`TypeTest`) are also given to perform subtype
    * checks on these types.
    *
    * Type hierarchy
    * ```none
    *
  ...
  trait reflectModule:
    ...
    trait CompilationInfoModule:
      ...
      /** Expose macro-specific settings as a list of strings. Settings can be
        * set from command line with help of -Xmacro-settings options.
        *
        * These will be used to expand any transparent macros or any
        * non-transparent macro that is forced to expand while expanding the
        * transparent macro. Non-transparent macros are not guaranteed to be
        * expanded with the same set of settings.
        */
      @experimental
      def XmacroSettings: List[String]

    /** Returns the `Term` representation this expression */
    extension (expr: Expr[Any]) def asTerm: Term
    ...
    trait TreeMethods:
      ...
      extension (self: Tree)
        ...
        /** Convert this tree to an `quoted.Expr[Any]` if the tree is a valid
          * expression or throws
          */
        def asExpr: Expr[Any]
      end extension

      /** Convert this tree to an `quoted.Expr[T]` if the tree is a valid
        * expression or throws
        */
      extension (self: Tree) def asExprOf[T](using Type[T]): Expr[T]
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if a `Tree`
      * is a `PackageClause`
      */
    ...
    trait PackageClauseModule:
      ...
      /** Matches a package clause `package pid { stats }` and extracts the
        * `pid` and `stats`
        */
    ...
    /** Tree representing an export clause in the source code. Export forwarders
      * generated from this clause appear in the same scope.
      */
    ...
    /** Tree representing a class definition. This includes anonymous class
      * definitions and the class of a module object
      */
    ...
    trait ClassDefModule:
      ...
      /** Create a class definition tree
        ...
        *   `Symbol.newClass`.
        * @param parents
        *   The parents trees class. The trees must align with the parent types
        *   of `cls`. Parents can be `TypeTree`s if they don't have term
        *   parameter, otherwise the can be `Term` containing the `New` applied
        *   to the parameters of the extended class.
        * @param body
        *   List of members of the class. The members must align with the
        *   members of `cls`.
        */
      // TODO add selfOpt: Option[ValDef]?
      @experimental def apply(
          cls: Symbol,
          parents: List[Tree /* Term | TypeTree */ ],
          body: List[Statement]
      ): ClassDef
      def copy(original: Tree)(
          name: String,
          constr: DefDef,
          parents: List[Tree /* Term | TypeTree */ ],
      ...
      def unapply(cdef: ClassDef): (
          String,
          DefDef,
          List[Tree /* Term | TypeTree */ ],
          Option[ValDef],
          List[Statement]
      )
      ...
      /** Create the ValDef and ClassDef of a module (equivalent to an `object`
        ...
        * @return
        *   The module lazy val definition and module class definition. These
        *   should be added one after the other (in that order) in the body of a
        *   class or statements of a block.
        *
        * @syntax
        *   markdown
        */
      // TODO add selfOpt: Option[ValDef]?
      @experimental def module(
          module: Symbol,
          parents: List[Tree /* Term | TypeTree */ ],
          body: List[Statement]
      ): (ValDef, ClassDef)
    ...
    trait ClassDefMethods:
      extension (self: ClassDef)
        ...
        /** List of extended parent classes or traits. The first parent is
          * always a class.
          */
    ...
    trait DefDefModule:
      ...
      /** Create a method definition `def f[..](...)` with the signature defined
        * in the symbol.
        *
        * The `rhsFn` is a function that receives references to its parameters
        * and should return `Some` containing the implementation of the method.
        * Returns `None` the method has no implementation. Any definition
        * directly inside the implementation should have `symbol` as owner.
        *
      ...
      def unapply(
          ddef: DefDef
      ): (String, List[ParamClause], TypeTree, Option[Term])
    ...
    trait DefDefMethods:
      extension (self: DefDef)
        ...
        /** List of leading type parameters or Nil if the method does not have
          * leading type parameters.
          *
          * Note: Non leading type parameters can be found in extension methods
          * such as
          * ```scala
          * //{
          * type A
        ...
        /** List of parameter clauses following the leading type parameters or
          * all clauses. Return all parameter clauses if there are no leading
          * type parameters.
          *
          * Non leading type parameters can be found in extension methods such
          * as
          * ```scala
          * //{
          * type T
        ...
        /** The tree of the implementation of the method. Returns `None` if the
    ...
    /** Tree representing a value definition in the source code This includes
      * `val`, `lazy val`, `var`, `object` and parameter definitions.
      */
    ...
    trait ValDefModule:
      ...
      /** Create a value definition `val x`, `var x` or `lazy val x` with the
        * signature defined in the symbol.
        *
        * The `rhs` should return be `Some` containing the implementation of the
        * method. Returns `None` the method has no implementation. Any
        * definition directly inside the implementation should have `symbol` as
        * owner.
        *
        * Use `Symbol.asQuotes` to create the rhs using quoted code.
        *
      ...
      def copy(
          original: Tree
      )(name: String, tpt: TypeTree, rhs: Option[Term]): ValDef
      ...
      /** Creates a block `{ val x1 = <terms(0): Term>; ...; val xn =
        * <terms(n-1): Term>; <body(List(x1, ..., xn)): Term> }`
        *
        * Usage:
        * ```
    ...
    /** Tree representing a type (parameter or member) definition in the source
      * code
      */
    ...
    trait TermModule:
      ...
      /** Returns a term that is functionally equivalent to `t`, however if `t`
        * is of the form `((y1, ..., yn) => e2)(e1, ..., en)` then it optimizes
        * this the top most call by returning the `Some` with the result of
        * beta-reducing the application. Otherwise returns `None`.
        *
        * To retain semantics the argument `ei` is bound as `val yi = ei` and
        * by-name arguments to `def yi = ei`. Some bindings may be elided as an
        * early optimization.
        */
    ...
    trait TermMethods:
      extension (self: Term)
        ...
        /** Replace Inlined nodes and InlineProxy references to underlying
          * arguments. The resulting tree is useful for inspection of the value
          * or content of a non-inline argument.
          *
          * Warning: This tree may contain references that are out of scope and
          * should not be used in the generated code. This method should only
          * used to port Scala 2 that used to access their outer scope
          * unsoundly.
          */
        def underlyingArgument: Term

        /** Replace Ident nodes references to the underlying tree that defined
          * them. The resulting tree is useful for inspection of the definition
          * of some bindings.
          *
          * Warning: This tree may contain references that are out of scope and
          * should not be used in the generated code. This method should only
        ...
        /** An apply node with given argument list `tree(args(0), ...,
          * args(args.length - 1))`
          */
        def appliedToArgs(args: List[Term]): Apply

        /** The current tree applied to given argument lists: `tree (argss(0))
          * ... (argss(argss.length -1))`
          */
        ...
        /** The current tree applied to given type arguments: `tree[targ0, ...,
          * targN]`
          */
        def appliedToTypes(targs: List[TypeRepr]): Term

        /** The current tree applied to given type argument list:
    ...
    trait RefModule:
      ...
      /** Create a reference tree from a symbol
        *
        * If `sym` refers to a class member `foo` in class `C`, returns a tree
        * representing `C.this.foo`.
        *
        * If `sym` refers to a local definition `foo`, returns a tree
        * representing `foo`.
        *
        * @note
        *   In both cases, the constructed tree should only be spliced into the
        *   places where such accesses make sense. For example, it is incorrect
        *   to have `C.this.foo` outside the class body of `C`, or have `foo`
    ...
    /** Tree representing a selection of definition with a given name on a given
      * prefix
      */
    type Select <: Ref
    ...
    trait SelectModule:
      ...
      /** Select a field or a non-overloaded method by name
        *
        * @note
        *   The method will produce an assertion error if the selected method is
        *   overloaded. The method `overloaded` should be used in that case.
        */
    ...
    /** Tree representing an argument passed with an explicit name. Such as
      * `arg1 = x` in `foo(arg1 = x)`
      */
    type NamedArg <: Term
    ...
    /** Tree representing an application of arguments. It represents a single
      * list of arguments, multiple argument lists will have nested `Apply`s
      */
    type Apply <: Term
    ...
    trait TypeApplyModule:
      ...
      /** Create a function type application `<fun: Term>[<args:
        * List[TypeTree]>]`
        */
      ...
      /** Matches a function type application `<fun: Term>[<args:
        * List[TypeTree]>]`
        */
    ...
    /** Tree representing a type ascription `x: T` in the source code.
      *
      * Also represents a pattern that contains a term `x`. Other `: T` patterns
      * use the more general `TypedOrTest`.
      */
    ...
    /** A lambda `(...) => ...` in the source code is represented as a local
    ...
    /** A lambda `(...) => ...` in the source code is represented as a local
      ...
      * ```
      * @note
      *   Due to the encoding, in pattern matches the case for `Lambda` should
      *   come before the case for `Block` to avoid mishandling of `Lambda`.
      */
    ...
    trait LambdaModule:
      ...
      /** Matches a lambda definition of the form
        * ```scala sc:nocompile
        * Block(
        *   (DefDef(_, _, params :: Nil, _, Some(body))) :: Nil,
        *   Closure(meth, _)
        * )
        * ```
      ...
      /** Generates a lambda with the given method type.
        ...
        * @param rhsFn
        *   Function that receives the `meth` symbol and the a list of
        *   references to the `params`
        */
      def apply(
          owner: Symbol,
          tpe: MethodType,
          rhsFn: (Symbol, List[Tree]) => Tree
      ): Block
    end LambdaModule
    ...
    /** Tree representing an if/then/else `if (...) ... else ...` in the source
      * code
      */
    type If <: Term
    ...
    trait IfModule:
      ...
      /** Create an if/then/else `if (<cond: Term>) <thenp: Term> else <elsep:
        * Term>`
        */
      ...
      /** Matches an if/then/else `if (<cond: Term>) <thenp: Term> else <elsep:
        * Term>`
        */
    ...
    trait MatchModule:
      ...
      /** Creates a pattern match `<scrutinee: Term> match { <cases:
        * List[CaseDef]> }`
        */
      ...
      /** Matches a pattern match `<scrutinee: Term> match { <cases:
        * List[CaseDef]> }`
        */
    ...
    /** Tree representing a summoning match `summonFrom { ... }` in the source
      * code
      */
    ...
    trait SummonFromMethods:
      extension (self: SummonFrom) def cases: List[CaseDef]
      end extension
    end SummonFromMethods

    /** Tree representing a try catch `try x catch { ... } finally { ... }` in
      * the source code
      */
    type Try <: Term
    ...
    trait TryModule:
      ...
      /** Create a try/catch `try <body: Term> catch { <cases: List[CaseDef]> }
        * finally <finalizer: Option[Term]>`
        */
      def apply(expr: Term, cases: List[CaseDef], finalizer: Option[Term]): Try

      def copy(
          original: Tree
      )(expr: Term, cases: List[CaseDef], finalizer: Option[Term]): Try

      /** Matches a try/catch `try <body: Term> catch { <cases: List[CaseDef]> }
        * finally <finalizer: Option[Term]>`
        */
    ...
    trait ReturnModule:
      ...
      /** Matches `return <expr: Term>` and extracts the expression and symbol
        * of the method
        */
    ...
    trait InlinedModule:
      this: Inlined.type =>
      def apply(
          call: Option[Tree /* Term | TypeTree */ ],
      ...
      def unapply(
          x: Inlined
      ): (Option[Tree /* Term | TypeTree */ ], List[Definition], Term)
    ...
    /** Tree representing a selection of definition with a given name on a given
      * prefix and number of nested scopes of inlined trees
      */
    ...
    trait SelectOuterModule:
      this: SelectOuter.type =>
      def apply(qualifier: Term, name: String, levels: Int): SelectOuter
      def copy(
          original: Tree
      )(qualifier: Term, name: String, levels: Int): SelectOuter
    ...
    trait WhileModule:
      ...
      /** Creates a while loop `while (<cond>) <body>` and returns (<cond>,
        * <body>)
        */
    ...
    /** Tree representing a type ascription or type test pattern `x: T` in the
      * source code.
      */
    ...
    trait TypedOrTestModule:
      this: TypedOrTest.type =>
    ...
    trait TypeIdentMethods:
      extension (self: TypeIdent) def name: String
      end extension
    end TypeIdentMethods

    /** Type tree representing a selection of definition with a given name on a
      * given term prefix
      */
    ...
    trait TypeProjectionModule:
      this: TypeProjection.type =>
      def copy(
          original: Tree
      )(qualifier: TypeTree, name: String): TypeProjection
      def unapply(x: TypeProjection): (TypeTree, String)

    /** Makes extension methods on `TypeProjection` available without any
      * imports
      */
    ...
    trait SingletonMethods:
      extension (self: Singleton) def ref: Term
      end extension
    ...
    trait RefinedModule:
      ...
      def copy(
          original: Tree
      )(tpt: TypeTree, refinements: List[Definition]): Refined
    ...
    trait AppliedModule:
      ...
      def apply(
          tpt: TypeTree,
          args: List[Tree /*TypeTree | TypeBoundsTree*/ ]
      ): Applied
      def copy(
          original: Tree
      )(tpt: TypeTree, args: List[Tree /*TypeTree | TypeBoundsTree*/ ]): Applied
      def unapply(
          x: Applied
      ): (TypeTree, List[Tree /*TypeTree | TypeBoundsTree*/ ])
    ...
    trait MatchTypeTreeModule:
      this: MatchTypeTree.type =>
      def apply(
          bound: Option[TypeTree],
          selector: TypeTree,
          cases: List[TypeCaseDef]
      ): MatchTypeTree
      def copy(original: Tree)(
          bound: Option[TypeTree],
          selector: TypeTree,
      ...
      def unapply(
          x: MatchTypeTree
      ): (Option[TypeTree], TypeTree, List[TypeCaseDef])
    ...
    trait ByNameMethods:
      extension (self: ByName) def result: TypeTree
      end extension
    end ByNameMethods
    ...
    trait LambdaTypeTreeModule:
      this: LambdaTypeTree.type =>
      def apply(
          tparams: List[TypeDef],
          body: Tree /*TypeTree | TypeBoundsTree*/
      ): LambdaTypeTree
      def copy(original: Tree)(
          tparams: List[TypeDef],
          body: Tree /*TypeTree | TypeBoundsTree*/
      ...
      def unapply(
          tree: LambdaTypeTree
      ): (List[TypeDef], Tree /*TypeTree | TypeBoundsTree*/ )

    /** Makes extension methods on `LambdaTypeTree` available without any
      * imports
      */
    ...
    trait TypeBindModule:
      ...
      def copy(
          original: Tree
      )(name: String, tpt: Tree /*TypeTree | TypeBoundsTree*/ ): TypeBind
    ...
    /** Makes extension methods on `TypeBoundsTree` available without any
      * imports
      */
    ...
    /** Type tree representing wildcard type bounds written in the source. The
      * wildcard type `_` (for example in in `List[_]`) will be a type tree that
    ...
    /** Makes extension methods on `WildcardTypeTree` available without any
      * imports
      */
    ...
    trait WildcardTypeTreeMethods:
      extension (self: WildcardTypeTree) def tpe: TypeRepr
      end extension
    ...
    trait CaseDefModule:
      ...
      def copy(
          original: Tree
      )(pattern: Tree, guard: Option[Term], rhs: Term): CaseDef
    ...
    trait UnapplyModule:
      ...
      /** Create an `Unapply` tree representing a pattern
        * `<fun>(<patterns*>)(using <implicits*>)`
        */
      def apply(fun: Term, implicits: List[Term], patterns: List[Tree]): Unapply

      /** Copy an `Unapply` tree representing a pattern
        * `<fun>(<patterns*>)(using <implicits*>)`
        */
      def copy(
          original: Tree
      )(fun: Term, implicits: List[Term], patterns: List[Tree]): Unapply

      /** Matches an `Unapply(fun, implicits, patterns)` tree representing a
        * pattern `<fun>(<patterns*>)(using <implicits*>)`
        */
    ...
    trait UnapplyMethods:
      extension (self: Unapply)
        /** The extractor function of the pattern.
          *
          * It may be a reference to the `unapply` method of the pattern or may
          * be a partially applied tree containing type parameters and leading
          * given parameters.
          */
        def fun: Term
    ...
    trait AlternativesMethods:
      extension (self: Alternatives) def patterns: List[Tree]
      end extension
    end AlternativesMethods

    /** A parameter clause `[X1, ..., Xn]` or `(x1: X1, ..., xn: Xx)`
      *
      * `[X1, ..., Xn]` are represented with `TypeParamClause` and `(x1: X1,
      * ..., xn: Xx)` are represented with `TermParamClause`
      *
    ...
    trait ParamClauseModule:
      this: ParamClause.type =>
    ...
    /** A term parameter clause `(x1: X1, ..., xn: Xx)` Can also be `(implicit
      * X1, ..., Xn)`, `(given X1, ..., Xn)` or `(given x1: X1, ..., xn: Xn)`
      */
    type TermParamClause <: ParamClause

    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `ParamClause` is a `TermParamClause`
      */
    ...
    trait TermParamClauseModule:
      this: TermParamClause.type =>
      def apply(params: List[ValDef]): TermParamClause
      def unapply(x: TermParamClause): Some[List[ValDef]]

    /** Makes extension methods on `TermParamClause` available without any
      * imports
      */
    ...
    trait TermParamClauseMethods:
      extension (self: TermParamClause)
        ...
        /** Is this an implicit parameter clause `(implicit x1: X1, ..., xn:
          * Xn)`
          */
        def isImplicit: Boolean

        /** Is this a given parameter clause `(using X1, ..., Xn)` or `(using
          * x1: X1, ..., xn: Xn)`
          */
        def isGiven: Boolean
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `ParamClause` is a `TypeParamClause`
      */
    ...
    trait TypeParamClauseModule:
      this: TypeParamClause.type =>
      def apply(params: List[TypeDef]): TypeParamClause
      def unapply(x: TypeParamClause): Some[List[TypeDef]]

    /** Makes extension methods on `TypeParamClause` available without any
      * imports
      */
    ...
    /** Import/Export selectors:
      ...
      *   - GivenSelector: `.given`/`.{given T}` in `export foo.given`/`import
      *     foo.{given T}`
      */
    ...
    trait SimpleSelectorModule:
      this: SimpleSelector.type =>
      def unapply(x: SimpleSelector): Some[String]

    /** Makes extension methods on `SimpleSelector` available without any
      * imports
      */
    ...
    /** Rename import/export selector: `.{bar => baz}` in `import foo.{bar =>
      * baz}`
      */
    type RenameSelector <: Selector

    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `Selector` is a `RenameSelector`
      */
    ...
    /** Makes extension methods on `RenameSelector` available without any
      * imports
      */
    ...
    /** given import/export selector: `.given`/`.{given T}` in `import
      * foo.given`/`export foo.{given T}`
      */
    type GivenSelector <: Selector

    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `Selector` is a `GivenSelector`
      */
    ...
    trait GivenSelectorMethods:
      extension (self: GivenSelector) def bound: Option[TypeTree]
    ...
    trait TypeReprMethods:
      extension (self: TypeRepr)
        ...
        /** Is `self` type the same as `that` type? This is the case iff `self
          * <:< that` and `that <:< self`.
          */
        ...
        /** Widen from singleton type to its underlying non-singleton base type
          * by applying one or more `underlying` dereferences, Also go from => T
          * to T. Identity for all other types. Example:
          *
          * class Outer { class C ; val x: C } def o: Outer <o.x.type>.widen =
          * o.C
          */
        def widen: TypeRepr

        /** Widen from TermRef to its underlying non-termref base type, while
          * also skipping ByName types.
          */
        ...
        /** Follow aliases, annotated types until type is no longer alias type,
          * annotated type.
          */
        def dealias: TypeRepr

        /** A simplified version of this type which is equivalent wrt =:= to
          * this type. Reduces typerefs, applied match types, and and or types.
          */
        ...
        /** The base classes of this type with the class itself as first
          * element.
          */
        def baseClasses: List[Symbol]

        /** The least type instance of given class which is a super-type of this
          * type. Example:
          * {{{
          *    class D[T]
        ...
        /** Is this type an instance of a non-bottom subclass of the given class
          * `cls`?
          */
        ...
        /** Is this type a function type?
          *
          * @return
          *   true if the dealiased type of `self` without refinement is
          *   `FunctionN[T1, T2, ..., Tn]`
          *
          * @note
          *   The function
          ...
          *   - returns false for `List[Int]`, despite that `List[Int] <:< Int
          *     \=> Int`.
          */
        ...
        /** The current type applied to given type arguments: `this[targ0, ...,
          * targN]`
          */
        def appliedTo(targs: List[TypeRepr]): TypeRepr

        /** Substitute all types that refer in their symbol attribute to one of
          * the symbols in `from` by the corresponding types in `to`.
          */
    ...
    trait ConstantTypeMethods:
      extension (self: ConstantType) def constant: Constant
      end extension
    ...
    trait AppliedTypeModule:
      ...
      /** Applied the type constructor `T` to a list of type arguments
        * `T_1,..,T_n` to create `T[T_1,..,T_n]`
        */
    ...
    /** Type of a by-name definition of type `=>T`.
      ...
      * ```
      *
      * May also represent a the return type of a parameterless method
      * definition such as
      * ```scala
      * def foo: Int = ???
      * ```
    ...
    trait ByNameTypeMethods:
      extension (self: ByNameType) def underlying: TypeRepr
      end extension
    ...
    trait ThisTypeMethods:
      extension (self: ThisType) def tref: TypeRepr
      end extension
    end ThisTypeMethods
    ...
    trait RecursiveThisMethods:
      extension (self: RecursiveThis) def binder: RecursiveType
      end extension
    ...
    trait RecursiveTypeModule:
      ...
      /** Create a RecType, normalizing its contents. This means:
        *
        *   1. Nested Rec types on the type's spine are merged with the outer
        *      one. 2. Any refinement of the form `type T = z.T` on the spine of
        *      the type where `z` refers to the created rec-type is replaced by
        *      `type T`. This avoids infinite recursions later when we try to
    ...
    /** Type of the definition of a method taking a single list of type or term
      * parameters
      */
    type LambdaType <: TypeRepr

    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `TypeRepr` is a `LambdaType`
      */
    ...
    /** Type of the definition of a method taking a single list of parameters.
      * It's return type may be a MethodType.
      */
    type MethodType <: MethodOrPoly

    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `TypeRepr` is a `MethodType`
      */
    ...
    trait MethodTypeModule:
      ...
      def apply(paramNames: List[String])(
          ...
          resultTypeExp: MethodType => TypeRepr
      ): MethodType
    ...
    trait MethodTypeMethods:
      extension (self: MethodType)
        /** Is this the type of using parameter clause `(implicit X1, ..., Xn)`,
          * `(using X1, ..., Xn)` or `(using x1: X1, ..., xn: Xn)`
          */
        def isImplicit: Boolean

        /** Is this the type of erased parameter clause `(erased x1: X1, ...,
          * xn: Xn)`
          */
    ...
    /** Type of the definition of a type lambda taking a list of type
      * parameters. It's return type may be a TypeLambda.
      */
    type TypeLambda <: LambdaType

    /** `TypeTest` that allows testing at runtime in a pattern match if a
      * `TypeRepr` is a `TypeLambda`
      */
    ...
    trait BooleanConstantModule:
      this: BooleanConstant.type =>
    ...
    trait UnitConstantModule:
      this: UnitConstant.type =>
    ...
    trait NullConstantModule:
      this: NullConstant.type =>
    ...
    trait ImplicitsModule:
      ...
      /** Find a given instance of type `T` in the current scope provided by the
        * current enclosing splice. Return an `ImplicitSearchResult`.
        *
        * @param tpe
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `ImplicitSearchResult` is an `ImplicitSearchSuccess`
      */
    given ImplicitSearchSuccessTypeTest
        : TypeTest[ImplicitSearchResult, ImplicitSearchSuccess]

    type ImplicitSearchSuccess <: ImplicitSearchResult

    /** Makes extension methods on `ImplicitSearchSuccess` available without any
      * imports
      */
    ...
    trait ImplicitSearchSuccessMethods:
      extension (self: ImplicitSearchSuccess) def tree: Term
      end extension
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `ImplicitSearchResult` is an `ImplicitSearchFailure`
      */
    given ImplicitSearchFailureTypeTest
        : TypeTest[ImplicitSearchResult, ImplicitSearchFailure]

    /** Makes extension methods on `ImplicitSearchFailure` available without any
      * imports
      */
    ...
    trait ImplicitSearchFailureMethods:
      extension (self: ImplicitSearchFailure) def explanation: String
      end extension
    ...
    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `ImplicitSearchResult` is a `DivergingImplicit`
      */
    given DivergingImplicitTypeTest
        : TypeTest[ImplicitSearchResult, DivergingImplicit]

    type NoMatchingImplicits <: ImplicitSearchFailure

    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `ImplicitSearchResult` is a `NoMatchingImplicits`
      */
    given NoMatchingImplicitsTypeTest
        : TypeTest[ImplicitSearchResult, NoMatchingImplicits]

    type AmbiguousImplicits <: ImplicitSearchFailure

    /** `TypeTest` that allows testing at runtime in a pattern match if an
      * `ImplicitSearchResult` is an `AmbiguousImplicits`
      */
    given AmbiguousImplicitsTypeTest
    ...
    /** Symbol of a definition. Symbols can be compared with `==` to know if two
    ...
    trait SymbolModule:
      ...
      /** Symbol of the definition that encloses the current splicing context.
        *
        * For example, the following call to `spliceOwner` would return the
        * symbol `x`.
        * ```scala sc:nocompile
        * val x = ${ ... Symbol.spliceOwner ... }
        * ```
        *
        * For a macro splice, it is the symbol of the definition where the macro
        * expansion happens.
        */
      def spliceOwner: Symbol

      /** Get package symbol if package is either defined in current compilation
        * run or present on classpath.
        */
      def requiredPackage(path: String): Symbol

      /** Get class symbol if class is either defined in current compilation run
        * or present on classpath.
        */
      def requiredClass(path: String): Symbol

      /** Get module symbol if module is either defined in current compilation
        * run or present on classpath.
        */
      def requiredModule(path: String): Symbol

      /** Get method symbol if method is either defined in current compilation
        * run or present on classpath. Throws if the method has an overload.
        */
      ...
      /** Generates a new class symbol for a class with a parameterless
        * constructor.
        *
        * Example usage:
        * ```
        ...
        * @param parents
        *   The parent classes of the class. The first parent must not be a
        *   trait.
        * @param decls
        *   The member declarations of the class provided the symbol of this
        *   class
        * @param selfType
        *   The self type of the class if it has one
        *
        * This symbol starts without an accompanying definition. It is the
        * meta-programmer's responsibility to provide exactly one corresponding
        * definition by passing this symbol to the ClassDef constructor.
        *
        * @note
        *   As a macro can only splice code into the point at which it is
        *   expanded, all generated symbols must be direct or indirect children
        *   of the reflection context's owner.
        */
      ...
      /** Generates a new module symbol with an associated module class symbol,
        * this is equivalent to an `object` declaration in source code. This
        * method returns the module symbol. The module class can be accessed
        * calling `moduleClass` on this symbol.
        *
        * Example usage:
        * ```scala
        * //{
        ...
        *   trait.
        * @param decls
        *   A function that takes the symbol of the module class as input and
        *   return the symbols of its declared members
        * @param privateWithin
        *   the symbol within which this new method symbol should be private.
        *   May be noSymbol.
        *
        * This symbol starts without an accompanying definition. It is the
        * meta-programmer's responsibility to provide exactly one corresponding
        * definition by passing this symbol to `ClassDef.module`.
        *
        * @note
        *   As a macro can only splice code into the point at which it is
        *   expanded, all generated symbols must be direct or indirect children
      ...
      /** Generates a new method symbol with the given parent, name and type.
        *
        * To define a member method of a class, use the `newMethod` within the
        * `decls` function of `newClass`.
        *
        * @param parent
        ...
        * This symbol starts without an accompanying definition. It is the
        * meta-programmer's responsibility to provide exactly one corresponding
        * definition by passing this symbol to the DefDef constructor.
        *
        * @note
        *   As a macro can only splice code into the point at which it is
        *   expanded, all generated symbols must be direct or indirect children
      ...
      /** Works as the other newMethod, but with additional parameters.
        ...
        *   flag will be added. Can be `Private | Protected | Override |
        *   Deferred | Final | Method | Implicit | Given | Local | JavaStatic`
        * @param privateWithin
        *   the symbol within which this new method symbol should be private.
        *   May be noSymbol.
        */
      ...
      /** Generates a new val/var/lazy val symbol with the given parent, name
        * and type.
        *
        * This symbol starts without an accompanying definition. It is the
        * meta-programmer's responsibility to provide exactly one corresponding
        * definition by passing this symbol to the ValDef constructor.
        *
        ...
        *   `Private | Protected | Override | Deferred | Final | Param |
        *   Implicit | Lazy | Mutable | Local | ParamAccessor | Module | Package
        *   \| Case | CaseAccessor | Given | Enum | JavaStatic`
        * @param privateWithin
        *   the symbol within which this new method symbol should be private.
        *   May be noSymbol.
        * @note
      ...
      /** Generates a pattern bind symbol with the given parent, name and type.
        ...
        * This symbol starts without an accompanying definition. It is the
        * meta-programmer's responsibility to provide exactly one corresponding
        * definition by passing this symbol to the BindDef constructor.
        *
        * @param parent
        ...
        * @param flags
        *   extra flags to with which the symbol should be constructed. `Case`
      ...
      /** A fresh name for class or member symbol names.
        *
        * Fresh names are constructed using the following format `prefix +
        * "$macro$" + freshIndex`. The `freshIndex` are unique within the
        * current source file.
        *
    ...
    trait SymbolMethods:
      extension (self: Symbol)
        ...
        /** Owner of this symbol. The owner is the symbol in which this symbol
          * is defined. Throws if this symbol does not have an owner.
          */
        def owner: Symbol

        /** Owner of this symbol. The owner is the symbol in which this symbol
          * is defined. Returns `NoSymbol` if this symbol does not have an
          * owner.
          */
        ...
        /** Tree of this definition
          *
          * If this symbol `isClassDef` it will return `a `ClassDef`, if this
          * symbol `isTypeDef` it will return `a `TypeDef`, if this symbol
          * `isValDef` it will return `a `ValDef`, if this symbol `isDefDef` it
          * will return `a `DefDef` if this symbol `isBind` it will return `a
          * `Bind`, else will throw
          *
          ...
          *
          * tp.memberType(symbol) symbol.typeRef symbol.termRef
          */
        def tree: Tree
        ...
        /** Dummy val symbol that owns all statements within the initialization
          * of the class. This may also contain local definitions such as
          * classes defined in a `locally` block in the class.
          */
        ...
        /** Get all non-private methods defined directly inside the class,
        ...
        /** The symbols of each type parameter list and value parameter list of
          * this method, or Nil if this isn't a method.
          */
        ...
        /** The primary constructor of a class or trait, `noSymbol` if not
          * applicable.
          */
        def primaryConstructor: Symbol

        /** Fields of a case class type -- only the ones declared in primary
          * constructor
          */
        ...
        /** Case class or case object children of a sealed trait or cases of an
          * `enum`.
          */
        def children: List[Symbol]

        /** Returns a nested quote with this symbol as splice owner
          * (`Symbol.spliceOwner`).
          *
        ...
        /** Type reference to the symbol usable in the scope of its owner.
          *
          * To get a reference to a symbol from a specific prefix `tp`, use
          * `tp.select(symbol)` instead.
          * @see
          *   TypeReprMethods.select
          *
          * @pre
          *   symbol.isType returns true
          */
        def typeRef: TypeRef
    ...
    trait SignatureModule:
      ...
      /** Matches the method signature and returns its parameters and result
        * type.
        */
    ...
    trait SignatureMethods:
      extension (self: Signature)
        ...
        /** The signatures of the method parameters.
          *
          * Each *type parameter section* is represented by a single Int
          * corresponding to the number of type parameters in the section. Each
          * *term parameter* is represented by a String corresponding to the
    ...
    trait defnModule:
      ...
      /** Class symbol of a context function class `scala.FunctionN` or
        ...
        * @return
        *   class symbol of `scala.FunctionN` or `scala.ContextFunctionN` where
        *   `N == arity`
        */
      @experimental
      ...
      /** Function-like object that maps arity to symbols for classes
        ...
        *   - 23nd element is `NoSymbol` // TODO update when we will have more
        *     tuples
        *   - ...
        */
    ...
    trait FlagsModule:
      ...
      /** Is this an abstract override method?
        *
        * This corresponds to a definition declared as "abstract override def"
        * in the source. See
        * https://stackoverflow.com/questions/23645172/why-is-abstract-override-required-not-override-alone-in-subtrait
        * for examples.
        */
      @experimental def AbsOverride: Flags

      /** Is this generated by Scala compiler. Corresponds to ACC_SYNTHETIC in
        * the JVM.
        */
      def Artifact: Flags
      ...
      /** Is this symbol local? Used in conjunction with private/private[T] to
        * mean private[this] extends Modifier protected[this]
        */
      def Local: Flags

      /** Is this symbol marked as a macro. An inline method containing top
        * level splices
        */
      def Macro: Flags
      ...
      /** Is this symbol an object or its class (used for a ValDef or a ClassDef
        * extends Modifier respectively)
        */
      def Module: Flags
    ...
    trait PositionModule:
      ...
      /** Create a new position in the source with the given range. The range
    ...
    trait SourceFileModule:
      ...
      /** Returns the source file being compiled. The path is relative to the
    ...
    trait SourceFileMethods:
      extension (self: SourceFile)
        /** Path to this source file. May be `null` for virtual files such as in
          * the REPL.
          */
        @deprecated("Use getJPath, name, or path instead of jpath", "3.0.2")
        def jpath: java.nio.file.Path

        /** Path to this source file. May be `None` for virtual files such as in
          * the REPL.
          */
        ...
        /** Path of the source file.
          *
          * It does not necessarily point to a path in the filesystem, it could
          * be the path of a virtual file. Use `getJPath` to get paths to the
          * filesystem.
          */
        def path: String
    ...
    trait reportModule:
      ...
      /** Report an error at the position of the macro expansion and throw a
        * StopMacroExpansion
        */
      def errorAndAbort(msg: String): Nothing

      /** Report an error at the position of `expr` and throw a
        * StopMacroExpansion
        */
      def errorAndAbort(msg: String, expr: Expr[Any]): Nothing

      /** Report an error message at the given position and throw a
        * StopMacroExpansion
        */
    ...
    trait TreeAccumulator[X]:
      ...
      def foldTrees(x: X, trees: Iterable[Tree])(owner: Symbol): X =
        trees.foldLeft(x)((acc, y) => foldTree(acc, y)(owner))
      ...
      def foldOverTree(x: X, tree: Tree)(owner: Symbol): X =
        tree match
          ...
          case If(cond, thenp, elsep) =>
            foldTree(foldTree(foldTree(x, cond)(owner), thenp)(owner), elsep)(
              owner
            )
          ...
          case Try(block, handler, finalizer) =>
            foldTrees(
              foldTrees(foldTree(x, block)(owner), handler)(owner),
              finalizer
            )(owner)
          ...
          case ddef @ DefDef(_, paramss, tpt, rhs) =>
            ...
            foldTrees(
              foldTree(
                paramss.foldLeft(x)((acc, y) =>
                  foldTrees(acc, y.params)(owner)
                ),
                tpt
              )(owner),
              rhs
          ...
          case cdef @ ClassDef(_, constr, parents, self, body) =>
            ...
            foldTrees(
              foldTrees(
                foldTrees(foldTree(x, constr)(owner), parents)(owner),
                self
              )(owner),
              body
            )(owner)
          ...
          case Refined(tpt, refinements) =>
            foldTrees(foldTree(x, tpt)(owner), refinements)(owner)
          case Applied(tpt, args) =>
            foldTrees(foldTree(x, tpt)(owner), args)(owner)
          case ByName(result) => foldTree(x, result)(owner)
          case Annotated(arg, annot) =>
            foldTree(foldTree(x, arg)(owner), annot)(owner)
          case LambdaTypeTree(typedefs, arg) =>
            foldTree(foldTrees(x, typedefs)(owner), arg)(owner)
          case TypeBind(_, tbt) => foldTree(x, tbt)(owner)
          case TypeBlock(typedefs, tpt) =>
            foldTree(foldTrees(x, typedefs)(owner), tpt)(owner)
          case MatchTypeTree(boundopt, selector, cases) =>
            foldTrees(
              foldTree(boundopt.fold(x)(y => foldTree(x, y)(owner)), selector)(
                owner
              ),
              cases
            )(owner)
          ...
          case TypeBoundsTree(lo, hi) =>
            foldTree(foldTree(x, lo)(owner), hi)(owner)
          case CaseDef(pat, guard, body) =>
            foldTree(foldTrees(foldTree(x, pat)(owner), guard)(owner), body)(
              owner
            )
          case TypeCaseDef(pat, body) =>
            foldTree(foldTree(x, pat)(owner), body)(owner)
          case Bind(_, body) => foldTree(x, body)(owner)
          case Unapply(fun, implicits, patterns) =>
            foldTrees(
              foldTrees(foldTree(x, fun)(owner), implicits)(owner),
              patterns
            )(owner)
    ...
    /** Customizable tree mapper.
      ...
      * ```
      *
      * Use `Symbol.asQuotes` to create quotes with the correct owner within the
      * TreeMap.
      */
    trait TreeMap:
      ...
      def transformTree(tree: Tree)(owner: Symbol): Tree =
        tree match
          case tree: PackageClause =>
            PackageClause.copy(tree)(
              transformTerm(tree.pid)(owner).asInstanceOf[Ref],
              transformTrees(tree.stats)(tree.symbol)
            )
          case tree: Import =>
          ...
          case tree: TypeBoundsTree =>
            TypeBoundsTree.copy(tree)(
              transformTypeTree(tree.low)(owner),
              transformTypeTree(tree.hi)(owner)
            )
          ...
          case pattern: Unapply =>
            Unapply.copy(pattern)(
              transformTerm(pattern.fun)(owner),
              transformSubTrees(pattern.implicits)(owner),
              transformTrees(pattern.patterns)(owner)
            )
          case pattern: Alternatives =>
            Alternatives.copy(pattern)(transformTrees(pattern.patterns)(owner))
          case TypedOrTest(inner, tpt) =>
            TypedOrTest.copy(tree)(
              transformTree(inner)(owner),
              transformTypeTree(tpt)(owner)
            )
          case _ =>
          ...
          case tree: DefDef =>
            ...
            val newParamClauses = tree.paramss.mapConserve {
              ...
              case TermParamClause(params) =>
                TermParamClause(transformSubTrees(params)(owner))
            }
            DefDef.copy(tree)(
              tree.name,
              newParamClauses,
              transformTypeTree(tree.returnTpt)(owner),
              tree.rhs.map(x => transformTerm(x)(owner))
            )
          case tree: TypeDef =>
            val owner = tree.symbol
            TypeDef.copy(tree)(tree.name, transformTree(tree.rhs)(owner))
          case tree: ClassDef =>
            val constructor @ DefDef(_, _, _, _) =
              transformStatement(tree.constructor)(tree.symbol): @unchecked
        ...
        tree match
          ...
          case Apply(fun, args) =>
            Apply.copy(tree)(
              ...
              transformTerms(args)(owner)
            )
          case TypeApply(fun, args) =>
            TypeApply.copy(tree)(
              transformTerm(fun)(owner),
              transformTypeTrees(args)(owner)
            )
          case Literal(const) =>
            tree
          case New(tpt) =>
          ...
          case Assign(lhs, rhs) =>
            Assign.copy(tree)(
              transformTerm(lhs)(owner),
              transformTerm(rhs)(owner)
            )
          case Block(stats, expr) =>
            Block.copy(tree)(
              transformStats(stats)(owner),
              transformTerm(expr)(owner)
            )
          case If(cond, thenp, elsep) =>
            If.copy(tree)(
              transformTerm(cond)(owner),
              transformTerm(thenp)(owner),
              transformTerm(elsep)(owner)
            )
          case Closure(meth, tpt) =>
            Closure.copy(tree)(transformTerm(meth)(owner), tpt)
          case Match(selector, cases) =>
            Match.copy(tree)(
              transformTerm(selector)(owner),
              transformCaseDefs(cases)(owner)
            )
          ...
          case Try(block, cases, finalizer) =>
            Try.copy(tree)(
              transformTerm(block)(owner),
              transformCaseDefs(cases)(owner),
              finalizer.map(x => transformTerm(x)(owner))
            )
          case Repeated(elems, elemtpt) =>
            Repeated.copy(tree)(
              transformTerms(elems)(owner),
              transformTypeTree(elemtpt)(owner)
            )
          case Inlined(call, bindings, expansion) =>
            Inlined.copy(tree)(
              call,
              transformSubTrees(bindings)(owner),
              transformTerm(expansion)(owner)
            )
      ...
      def transformTypeTree(tree: TypeTree)(owner: Symbol): TypeTree =
        tree match
          ...
          case tree: Refined =>
            Refined.copy(tree)(
              transformTypeTree(tree.tpt)(owner),
              transformTrees(tree.refinements)(owner)
                .asInstanceOf[List[Definition]]
            )
          case tree: Applied =>
            Applied.copy(tree)(
              transformTypeTree(tree.tpt)(owner),
              transformTrees(tree.args)(owner)
            )
          case tree: MatchTypeTree =>
            MatchTypeTree.copy(tree)(
              tree.bound.map(b => transformTypeTree(b)(owner)),
              transformTypeTree(tree.selector)(owner),
              transformTypeCaseDefs(tree.cases)(owner)
            )
          case tree: ByName =>
            ByName.copy(tree)(transformTypeTree(tree.result)(owner))
          case tree: LambdaTypeTree =>
            LambdaTypeTree.copy(tree)(
              transformSubTrees(tree.tparams)(owner),
              transformTree(tree.body)(owner)
            )
          case tree: TypeBind =>
      ...
      def transformCaseDef(tree: CaseDef)(owner: Symbol): CaseDef =
        CaseDef.copy(tree)(
          transformTree(tree.pattern)(owner),
          tree.guard.map(x => transformTerm(x)(owner)),
          transformTerm(tree.rhs)(owner)
        )

      def transformTypeCaseDef(tree: TypeCaseDef)(owner: Symbol): TypeCaseDef =
        TypeCaseDef.copy(tree)(
          transformTypeTree(tree.pattern)(owner),
          transformTypeTree(tree.rhs)(owner)
        )

      def transformStats(trees: List[Statement])(
          owner: Symbol
      ): List[Statement] =
      ...
      def transformTypeTrees(trees: List[TypeTree])(
          owner: Symbol
      ): List[TypeTree] =
        trees mapConserve (x => transformTypeTree(x)(owner))

      def transformCaseDefs(trees: List[CaseDef])(
          owner: Symbol
      ): List[CaseDef] =
        trees mapConserve (x => transformCaseDef(x)(owner))

      def transformTypeCaseDefs(trees: List[TypeCaseDef])(
          owner: Symbol
      ): List[TypeCaseDef] =
        trees mapConserve (x => transformTypeCaseDef(x)(owner))

      def transformSubTrees[Tr <: Tree](trees: List[Tr])(
          owner: Symbol
      ): List[Tr] =
    ...
    /** Type class used in `show` methods to provide customizable `String`
      * representations
      */
    trait Printer[T]:
    ...
    /** Module object of `type Printer`. Contains custom printers such as
      * `TreeCode`, `TreeAnsiCode`, `TreeCases`, `TypeReprCode`, ...,
      * `SymbolFullName` and `FlagsCombination`.
      */
    ...
    trait PrinterModule:
      ...
      /** Prints a pattern like representation of the `Tree`. It displays the
      ...
      /** Prints the type in source code. Same as `TypeReprCode` but does not
        * print full package prefixes.
        */
      ...
      /** Prints a pattern like representation of the `TypeRepr`. It displays
  ...
  /** Type of a `Quotes` provided by a splice within a quote that took this
    * context.
    */
  type Nested = Quotes
end Quotes

...
/** Whether the code type checks in the current context?
  ...
  *
  * @return
  *   false if the code has syntax error or type error in the current context,
  *   otherwise returns true.
  *
  * The code should be a sequence of expressions or statements that may appear
  * in a block.
  */
...
/** Whether the code type checks in the current context? If not, returns a list
  * of errors encountered on compilation. IMPORTANT: No stability guarantees are
  * provided on the format of these errors. This means the format and the API
  * may change from version to version. This API is to be used for testing
  * purposes only.
  *
  ...
  *
  * @return
  *   a list of errors encountered during parsing and typechecking.
  *
  * The code should be a sequence of expressions or statements that may appear
  * in a block.
  */

...
object Tuples:
  ...
  def fromArray(xs: Array[Object]): Tuple = xs.length match
    ...
    case 9 =>
      Tuple9(xs(0), xs(1), xs(2), xs(3), xs(4), xs(5), xs(6), xs(7), xs(8))
    case 10 =>
      Tuple10(
        xs(0),
        xs(1),
    ...
    case _ =>
      TupleXXL
        .fromIArray(xs.clone().asInstanceOf[IArray[Object]])
        .asInstanceOf[Tuple]

  def fromIArray(xs: IArray[Object]): Tuple =
    if xs.length <= 22 then fromArray(xs.asInstanceOf[Array[Object]])
    ...
    (self: Any) match
      ...
      case self: Tuple22[
        ...
        val arr: Array[Object] = Array(
          ...
          self._1.asInstanceOf[Object],
          self._2.asInstanceOf[Object],
          self._3.asInstanceOf[Object],
          self._4.asInstanceOf[Object],
          self._5.asInstanceOf[Object],
          self._6.asInstanceOf[Object],
          self._7.asInstanceOf[Object],
          self._8.asInstanceOf[Object],
          self._9.asInstanceOf[Object],
          self._10.asInstanceOf[Object],
          self._11.asInstanceOf[Object],
          self._12.asInstanceOf[Object],
          self._13.asInstanceOf[Object],
          self._14.asInstanceOf[Object],
          self._15.asInstanceOf[Object],
          self._16.asInstanceOf[Object],
          self._17.asInstanceOf[Object],
          self._18.asInstanceOf[Object],
          self._19.asInstanceOf[Object],
          self._20.asInstanceOf[Object],
          self._21.asInstanceOf[Object],
          self._22.asInstanceOf[Object]
        )
        TupleXXL
    ...
    x match
      case x: Product =>
        x.productArity match
          ...
          case 13 =>
            x.isInstanceOf[Tuple13[?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?]]
          case 14 =>
            x.isInstanceOf[Tuple14[?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?]]
          case 15 =>
            x.isInstanceOf[Tuple15[?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?]]
          case 16 =>
            x.isInstanceOf[
              Tuple16[?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?]
            ]
